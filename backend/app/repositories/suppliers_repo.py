...
from app.schemas.suppliers import SupplierAccountCreate, SupplierAddressCreate
...
def _create_user(
    ...
    user = User(
        ...
        role_id=get_role_id_by_name(db, ROLE_FOURNISSEUR),
        mobile_phone=mobile,
